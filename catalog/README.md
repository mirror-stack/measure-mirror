...
- 원 수리 팔 `0.673` 은 여섯 뽑기(0.673·0.596·0.692·0.654·0.615·0.538) 중 **최댓값**이었고
  통과 여유는 **1건**이었다. 여섯 번 중 제일 잘 나온 회차에서 한 건 차로 넘은 것이다.
...
- ~~"짝비교 12 대 3 · p=0.0176"을 커버리지 효과의 근거로 쓴 것~~ → 그 논거는 *"같은 세션이라
  ...
  모든 뽑기로 재계산하면 커버리지 효과는 **+0.099(약 5건) · t≈2.09** — **방향은 유지, 크기는 절반,
  유의성은 경계**다.
